...
<div id="admin_main2_1">
	<div class='aaaa'>
		...
		<div class='aaaa'>
			<a href = "#"><img src="../resources/images/모행.png" alt="테스트입니다" width="200" height="200" /></a>
		<div>일정관리</div>
		</div>
</div>
	<div id="admin_main2_2">
		<div class ="bbbb">
			<a href = "/MoHang/admin/AdminNotice.do"><img src="../resources/images/컴터임티.png" alt="테스트입니다" width="200" height="200" /></a>
				<div>게시판 관리</div>
		</div>
		<div class ="bbbb">
			<a href = "/MoHang/admin/AdminManagement.do"><img src="../resources/images/하트임티.png" alt="테스트입니다" width="200" height="200" /></a>
				<div>회원관리</div>
		</div>
		<div class ="bbbb">
			<a href = "#"><img src="../resources/images/책갈피임티.png" alt="테스트입니다" width="200" height="200" /></a>
				<div>메인슬라이드 관리</div>
		</div>
